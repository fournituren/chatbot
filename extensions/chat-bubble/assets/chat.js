    ...
    API: {
      ...
      streamResponse: async function(userMessage, conversationId, messagesContainer) {
        ...
        try {
          ...
          const streamUrl = 'https://chatbot-production-48d8.up.railway.app/chat';
      ...
      fetchChatHistory: async function(conversationId, messagesContainer) {
        try {
          ...
          const historyUrl = 'https://chatbot-production-48d8.up.railway.app/chat?history=true&conversation_id=';
    ...
    Auth: {
      ...
      startTokenPolling: function(conversationId, messagesContainer) {
        ...
        const poll = async () => {
          ...
          try {
            const tokenUrl = 'https://chatbot-production-48d8.up.railway.app/auth/token-status?conversation_id=' +
